...
[_SYM] = LAYOUT_planck_grid(
     ...
     _______, _______, _______, _______, _______, _______, _______, MOUSE, _______, _______,  _______,
),
...
* |      |      |  UP  |      |      |      |      |      |      |      |      |      |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      | LEFT | DOWN | RIGHT|      |      |      |Layer1| WH D | WH U |      |      |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* | UNDO | CUT  | COPY | PASTE|      |      |      |      | CTRL |      |      |      |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      |      | Back | BTN 2|      |             | BTN 1|WH Cli|      |      |      |
* `-----------------------------------------------------------------------------------'
*/
[_MOUSE] = LAYOUT_planck_grid(
    _______, _______, MS_UP,   _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, MS_LEFT, MS_DOWN, MS_RGHT, _______, _______, _______, MOUSE,   WH_DOWN,  WH_UP,   _______, _______,
    UNDO,    CUT,     COPY,    PASTE,   _______, _______, _______, _______, KC_LCTL,  _______, _______, _______,
    _______, _______, _______, KC_BTN4, MS_BTN2, _______, _______,  MS_BTN1, KC_BTN3, _______, _______, _______
),
};
